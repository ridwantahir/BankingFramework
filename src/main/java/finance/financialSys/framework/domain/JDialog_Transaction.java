...
public class JDialog_Transaction extends javax.swing.JDialog
{
    

    private AFinFrm parentframe;
    private String accnr, amountDeposit;
    
	public JDialog_Transaction(AFinFrm parent, String aaccnr, String title)
	{
		super(parent);
		parentframe=parent;
		accnr=aaccnr;
